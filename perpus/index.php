	...
	<div id="container">
		<div id="header">
			<div id="logo-perpustakaan-container">
				<image id="logo-perpustakaan" src="images/bxs-box.png" border=0 style="border:0; text-decoration:none; outline:none"> 
			</div>
...
<script>
	function return_confirmation(id) {
		let confDelete = confirm('Apakah Anda yakin ingin menghapus?');
		if (confDelete) {
			location.href = 'proses/anggota-hapus.php?id='+id;
		}
	}
</script>
</body>
