        ...
        <table id="table-input">
            <tr>
                ...
                <td class="isian-formulir">
                    <img src="images/<?php echo $foto; ?>" alt="foto-anggota" height="70px">
            ...
            <tr>
                ...
                <td class="isian-formulir">
                    <input type="text" name="nama" value="<?php echo $r_tampil_anggota['nama']; ?>" class="isian-formulir isian-formulir-border">
                </td>
            </tr>
            <tr>
                 ...
                 <?php
                    if ($r_tampil_anggota['jeniskelamin'] == "Pria") {
                        echo "<td class='isian-formulir'><input type='radio' name='jenis_kelamin' value='Pria' checked> Pria</td>
            </tr>
            <tr>
                ...
                <td class='isian-formulir'><input type='radio' name='jenis_kelamin' value='Wanita'> Wanita</td>";
                        ...
                        echo "<td class='isian-formulir'><input type='radio' name='jenis_kelamin' value='Pria'> Pria</td>
            </tr>
            <tr>
                <td class='label-formulir'></td>
